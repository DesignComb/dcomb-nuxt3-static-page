...
<template>
    <div class="w-full min-h-screen flex flex-row flex-wrap justify-center items-center">
        ...
        <div class="w-full relative border-y-solid border-1 mb-20">
            ...
            <div class="relative grid xl:grid-cols-2 lg:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-8 md:gap-12 justify-center flex-items-stretch px-12 md:px-48">
                <common-used-member-card>
                    ...
                    <template #decoration>
                        ...
                        <div class="absolute top-[40%] left-[72.5%] text-xl font-bold mix-blend-screen">BUILD</div>
                ...
                <common-used-member-card>
                    ...
                    <template #decoration>
                        ...
                        <div class="absolute top-[40%] left-[7.5%] text-xl font-bold mix-blend-screen">BACKEND</div>
