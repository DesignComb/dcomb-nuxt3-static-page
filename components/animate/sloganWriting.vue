...
onMounted(() => {
    document.querySelectorAll('path').forEach(function (path) {
        ...
        // Set properties to make the path invisible
        path.style.strokeDasharray = length.toString();
        path.style.strokeDashoffset = length.toString();

        // Animate the path
        path.getBoundingClientRect(); // Trigger a reflow, ensuring styles are applied
        path.style.transition = 'stroke-dashoffset 1.5s cubic-bezier(0, 0.55, 0.45, 1)';
...
<template>
    <div class="flex flex-wrap justify-center mx-auto scale-70 sm:scale-100 lg:scale-150">
        <svg class="w-full sm:w-1/2" id="f81736d0-66c3-4a06-b20f-d932e5c39fce" data-name="layer 1" xmlns="http://www.w3.org/2000/svg"
             viewBox="450 450 580 200">
            <title>DESIGN</title>
            <path class="main-font-color"
            ...
            <path class="secondary-font-color"
        ...
        <svg class="w-full sm:w-1/2 ml--16 lg:ml--12 mt--1" id="f81736d0-66c3-4a06-b20f-d932e5c39fce" data-name="layer 1" xmlns="http://www.w3.org/2000/svg"
             viewBox="900 440 580 200">
            <title>COMB</title>
            <path class="main-font-color"
...
<!--    <svg class="hidden sm:block" id="f81736d0-66c3-4a06-b20f-d932e5c39fce" data-name="layer 1" xmlns="http://www.w3.org/2000/svg"-->
